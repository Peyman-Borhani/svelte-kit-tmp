...
<div class="content">
	...
	<p > The page you're looking at is purely static HTML, with no client-side interactivity needed.
		 ...
		 Try viewing the page's source, or opening the devtools network panel and reloading.
	</p>

	<p > The <a href="/todos"> TODOs </a> page illustrates SvelteKit's data loading and form handling. 
...
<style>
	...
	.content {  max-width: var(--column-width);
				margin: 0 auto;
	}
